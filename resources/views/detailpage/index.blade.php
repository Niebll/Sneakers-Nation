   ...
   <body class="main-layout">
    ...
    <div class="layout_padding contact_section">
    	...
    	<div class="container-fluid ram">
    		<div class="row">
    			<div class="col-md-6">
    				<div class="emailal_box">
                    <div class="input_main">
                       <div class="container">
                          <form action="/action_page.php">
                            <div class="ellipsee">
                                <img src="images/Rectangl.png" alt="">
                  
                                <!-- <h3 style="margin-left: 15px; margin-top: 20px; font-weight: 600;">Lugas Richtigo</h3> -->
                            </div>
                            ...
                            <div>
                              <h1 style="font-weight: 600; padding-top: 30px;">Rewards</h1>
                            </div>

                            <div>
                              <div class="rewards">
                                <img src="images/Group 16.png" alt="">
                                <h4>Reguler Voucher</h4>
                              </div>
                              <div>
          ...
          <div class="col-md-6">
            <div class="emailaaaf_box">
              <div class="input_main">
                 <div class="container">
                    <form action="/action_page.php">
                      <!-- <div class="form-group">
                        <h1>Settings</h1>
                        <h3 style="text-decoration: solid;">Personal Profile</h3>
                      </div> -->
                      <div>
                        <img src="images/Component 59.png" alt="">

                      </div>

                      <div>
                        <h1 class="jrdn"><b>Air Jordan 1 Retro High OG</b></h1>
                      </div>

                      <div>
                        <button class="buyii_bt"><b>Add To Cart</b></button>
                      </div>

                      <div class="form-group">

                        <div class="subtotali" style="margin-top: 30px;">
                            <h3>Price</h3>
                            <h3 style="padding-left: 520px; padding-top: 4px;">US Size</h3>
                        </div>
                        <hr class="new4">
                        <div class="subtotali">
                            <h3>IDR 3.450.000</h3>
                            <h3 style="padding-left: 500px; padding-top: 4px;">10</h3>
                        </div>
                        <hr class="new4">
                        <div class="subtotali">
                            <h3>IDR 3.670.000</h3>
                            <h3 style="padding-left: 500px; padding-top: 4px;">10.5</h3>
                        </div>
                        <hr class="new4">
                        <div class="subtotali">
                            <h3>IDR 3.925.000</h3>
                            <h3 style="padding-left: 505px; padding-top: 4px;">11</h3>
                        </div>
                        <hr class="new4">
